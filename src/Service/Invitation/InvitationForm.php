	...
	public function getInvitationFieldsItem( $companyID, $departmentID){
        ...
        <div class="invitation-item-fields flex full-width flex-center">
            ...
            <div class="content flex flex-end">
                ...
                <div class="input-field profenda-field flex-grow <?php echo ( $departmentID !== false ? 'predefined' : ''); ?>">
                ...
                <div class="input-field profenda-field margin-left-auto no-margin-right">
                    ...
                    <button type="submit" class="invitationSend profenda-btn filled" name="refresh_action" value="invitation_send">
                        Send Invitation
