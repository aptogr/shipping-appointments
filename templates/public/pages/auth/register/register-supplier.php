						...
						<div class="login-content register-content full-width">
							...
							<div class="col s12">
								...
								<div class="flex register-types">
									...
									<a href="<?php echo site_url('register/supplier/new-company'); ?>" class="register-type-box">
									...
									<a href="<?php echo site_url('register/supplier/employee'); ?>" class="register-type-box">
